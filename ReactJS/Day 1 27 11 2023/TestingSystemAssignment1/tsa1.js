...
function ex1_question1() {
    var chuoi = "Tiên học lễ, hậu học văn".split(" ");
    console.log(chuoi);
    console.log(chuoi.length);
}
function ex1_question2() {
    var chuoi = "cách tốt nhất để làm mọi thứ là ngừng nói và làm ngay bây giờ và in ra màn hình".split(" ");
    console.log(chuoi);
    chuoi.forEach(function (ele) {
        ele = ele.charAt(0).toUpperCase() + ele.substring(1);
        console.log(ele);
    });
}
function ex1_question3() {
    var chuoi = "Họ* đi đôi *ới hàn*";
...
var ex2_question1 = function (array) {
    var min = array[0];
...
function ex4_question1() {
    ...
    var fullNameFunction = fullNameGlobal;
    console.log("Function scope:  " + fullNameFunction);
    var fullNameLexicalScope = fullNameGlobal;
    function hello() {
...
function ex4_question3(firstName, lastName) {
    function getting() {
        return firstName + " " + lastName;
    }
    return getting;
}
var DepartmentFile = require("./Department");
