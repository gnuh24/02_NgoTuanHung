...
public class WebSecutiryConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/api/v1/lego").permitAll()
				.antMatchers(HttpMethod.POST, "/api/v1/lego").hasAuthority("ADMIN")
				.antMatchers(HttpMethod.PUT, "/api/v1/lego/{id}").hasAuthority("ADMIN")
				.antMatchers(HttpMethod.DELETE, "/api/v1/lego/{id}").hasAuthority("ADMIN")
