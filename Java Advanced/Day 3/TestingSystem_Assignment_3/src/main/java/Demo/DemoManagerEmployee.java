...
public class DemoManagerEmployee {
	public static void main(String[] args) {
		...
		for (Account account : accountRepository.getAllEmployees()) {
		    System.out.println("Account ID: " + account.getAccountID());
		    System.out.println("Username: " + account.getUsername());
		    
		    if (account instanceof Employee) {
		    	Employee m = (Employee) account;
		        System.out.println("Employee");
		        System.out.println(m.getWorkingNumberOfYear());
		    }
		...
		for (Account account : accountRepository.getAllManager()) {
		    System.out.println("Account ID: " + account.getAccountID());
		    System.out.println("Username: " + account.getUsername());
